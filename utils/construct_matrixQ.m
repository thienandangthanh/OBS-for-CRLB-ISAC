...
% CONSTRUCT_MATRIXQ Construct matrix Q for optimization
%
% Inputs:
%   L        - Number of symbols
%   noise_s  - Sensing noise power
%   Phi      - Covariance matrix (CRBM*CRBM)
%   A        - Transmit steering matrix
%   dAtheta  - Derivative of A w.r.t. theta
%   dAphi    - Derivative of A w.r.t. phi
%   B        - Receive steering matrix
%   dBtheta  - Derivative of B w.r.t. theta
%   dBphi    - Derivative of B w.r.t. phi
%   U        - Diagonal matrix of channel coefficients
%
% Output:
%   Q        - Constructed matrix Q
