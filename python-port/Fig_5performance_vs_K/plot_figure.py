...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Plot Figure 5: Performance vs Number of Communication Users (K)')
...
def load_data():
    ...
    try:
        ...
        data_dict['wmmsesdr'] = scipy.io.loadmat('data_WMMSESDR_K.mat')
...
def create_performance_plot(data_dict, save_plots=False, output_dir='.'):
    """
    Create the performance vs number of users plot.
    ...
    if save_plots:
        plot_file = os.path.join(output_dir, 'fig5_algorithm_comparison_vs_K.png')
...
def main():
    ...
    """
    print("Starting Figure 5: Performance vs Number of Communication Users (K)")
    print("=" * 70)
